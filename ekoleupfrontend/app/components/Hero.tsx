  ...
  return (
    <section className="relative flex min-h-[921px] flex-col overflow-hidden lg:flex-row">
      <div className="z-10 flex w-full items-center bg-gradient-to-r from-[#0058ba]/5 to-transparent px-8 pb-20 pt-32 lg:w-1/2 lg:pl-24">
        <div className="max-w-xl">
          <h1 className="mb-8 text-5xl font-extrabold leading-[1.05] tracking-tight lg:text-[5.5rem]">
            Education For <br />
            <span className="italic text-[#0058ba]">Future</span> Leaders
          </h1>
          ...
          <div className="flex flex-col gap-4 sm:flex-row">
            <button className="rounded-full bg-[#0058ba] px-10 py-4 font-bold text-white">Our Programs</button>
            <button className="rounded-full border border-[#0058ba]/30 px-10 py-4 font-bold text-[#0058ba]">Learn More</button>
          </div>
        </div>
      </div>
      ...
      <div className="relative min-h-[500px] w-full lg:min-h-full lg:w-1/2">
        <div
          className="absolute right-0 top-0 h-[60%] w-full overflow-hidden lg:h-[55%]"
          style={{ clipPath: "polygon(0 0, 100% 0, 100% 100%, 35% 100%)" }}
        >
          <img
            alt="Interconnected global community"
        ...
        <div
          className="absolute bottom-0 right-0 h-[55%] w-[95%] overflow-hidden border-l-8 border-t-8 border-[#f9f5f8] lg:h-[58%]"
          style={{ clipPath: "polygon(45% 0, 100% 0, 100% 100%, 0 100%)" }}
        >
          <img
            alt="Diverse students in blended learning environment"
            className="h-full w-full object-cover"
